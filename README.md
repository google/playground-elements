...
| ------------ | --------------------------------------- | ---------------------------------------------------------------------------------------- | ------------------------------------ | ------------------------------------------ |
| `default`    | ![](images/colors/000000.png) `#000000` | `{}[];`                                                                                  | <code>&lt;p><u>foo</u>&lt;/p></code> | `{}:;`                                     |
| `atom`       | ![](images/colors/221199.png) `#221199` | `true`                                                                                   | `&amp;`                              | `bold`                                     |
| `attribute`  | ![](images/colors/0000CC.png) `#0000CC` |                                                                                          | <code>&lt;foo <u>bar</u>></code>     | <code>@media <u>screen</u> { }</code>      |
| `builtin`    | ![](images/colors/3300AA.png) `#3300AA` |                                                                                          |                                      | <code><u>#id</u> { }</code>                |
| `callee`     | ![](images/colors/000000.png) `#000000` | <code><u>func</u>()</code>                                                               |                                      | <code><u>calc</u>()</code>                 |
| `comment`    | ![](images/colors/AA5500.png) `#AA5500` | `// foo`                                                                                 | `<!-- foo -->`                       | `/* foo */`                                |
| `def`        | ![](images/colors/0000FF.png) `#0000FF` | <code>let <u>foo</u> = bar</code> <br> <code>/\*\*@param {string} <u>foo</u>\*/</code>   |                                      | `@media`                                   |
...
| `property`   | ![](images/colors/000000.png) `#000000` | <code>class foo { <u>bar</u>; } </code>                                                  |                                      | <code><u>color</u>:</code>                 |
| `qualifier`  | ![](images/colors/555555.png) `#555555` |                                                                                          |                                      | <code><u>.class</u> { }</code>             |
| `string`     | ![](images/colors/AA1111.png) `#AA1111` | `"foo"`                                                                                  | <code>&lt;a b=<u>"c"</u>></code>     | <code>content: <u>"foo"</u></code>         |
| `string-2`   | ![](images/colors/FF5500.png) `#FF5500` | `` `foo` `` <br> `/foo/`                                                                 |                                      | <code><u>zoom</u>: 50%</code> <sup>1</sup> |
| `tag`        | ![](images/colors/117700.png) `#117700` | <code>/\*\*<u>@param</u> {string} foo\*/</code>                                          | `<foo>`                              | <code><u>div</u> { }                       |
| `type`       | ![](images/colors/008855.png) `#008855` | <code>let foo: <u>string</u></code> <br> <code>/\*\*@param {<u>string</u>} foo\*/</code> |                                      |                                            |
| `variable`   | ![](images/colors/000000.png) `#000000` | <code>let foo = <u>bar</u></code>                                                        |                                      | <code>@keyframes <u>spin</u> { }</code>    |
| `variable-2` | ![](images/colors/0055AA.png) `#0055AA` | <code>(arg) => { <u>arg</u> }</code> <sup>2</sup>                                        |                                      |                                            |
| `variable-3` | ![](images/colors/008855.png) `#008855` |                                                                                          |                                      | <code>::<u>hover</u></code>                |
| `local`      | ![](images/colors/0000FF.png) `#0000FF` | <code>(<u>arg</u>) => { }</code>                                                         |                                      |                                            |
